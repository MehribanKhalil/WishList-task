...
const ProductCard = ({ img, category, name, price, status, item }) => {
  const { addToWishList, addedToWishlist,setAddedToWishlist } = useWishListContext()
  const handleClick = () => {
    addToWishList(item)
  }
    ...
    <div className='col-12 col-md-6 col-lg-4 mb-4'>
      ...
      <div id='product_card' className="text-center">
        ...
        <div className='product_content'>
          ...
          <button className='add_WishList_Btn' onClick={handleClick}>
          Add to Wishlist
            <CiHeart className='add_fav_icon' />
          </button>
        </div>
      </div>
